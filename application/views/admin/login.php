...
<script type="text/javascript">
  ...
  <div>
    <div class="Loginpart">
	<form action="<?= base_url() ?>admin/login" method="post" name="signinForm" id="signinForm">
      <div class="Whitebg">
        <div class="LoginTitle"><img src=" <?= $this->assets->url("login-icon.png","admin")?>" alt="Loign" title="Loign" class="Icon" /><strong>Welcome to </strong></div>
        ...
        <div>
         ...
         <!--   <div class="Right">
          ...
          <!--  <input name="Login" type="button" value="Login" class="GreenBut" />-->
            ...
            <a href=" <?= base_url()?>admin/forgot_password" class="Red-link" >Forgot Password?</a></div>
        </div>
