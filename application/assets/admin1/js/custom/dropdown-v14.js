(function (b) {
    ...
    b.extend(a.prototype, {
        _createDropDown: function (o, s) {
            ...
            ddSelWrap = b("<div>", {"class": "ddSelWrap", id: "ddSelWrap_" + o.id});
            ...
            ddOptHolder = b("<div>", {
                "class": "ddOptHolder", id: "ddOptHolder_" + o.id, click: function (t) {
                    t.stopPropagation();
            ...
            ddLabelHolder = b("<div>", {
                "class": "ddLabelHolder", id: "ddLabelHolder_" + o.id, click: function (t) {
                    if (b(this).hasClass("ddLabelHolderOpen")) {
                        t.stopPropagation()
                    }
                }
            });
            ddLabel = b("<p>", {"class": "ddLabel"});
            ddSelOptHolder = b("<div>", {
                "class": "ddSelOptHolder", id: "ddSelOptHolder_" + o.id, click: function (t) {
            ...
            ddOptionHolder = b("<div>", {"class": "ddOptionHolder", id: "ddOptionHolder_" + o.id});
            if (p.label != "" && p.label != undefined) {
            ...
            if (p.autoSelected) {
                ...
                if (p.displayOption == "comma") {
                    ...
                    if (p.showLabelOnClose) {
                        optWithLabelSpan = b("<span>", {"class": "ddSelectedVal"});
            ...
            function r() {
                ...
                b("#ddSelOptText_" + o.id).attr({width: "auto", size: t})
            }
                ...
                b("#" + o.id).children().each(function () {
                    if (b(this).is("optgroup")) {
                        ...
                        if (optionArr.length > 0) {
                            ddOptionLI = b("<li>", {
                                "class": "ddOptgroupLI", click: function (u) {
                                    u.stopPropagation();
                                    b("#ddSelOptText_" + o.id).focus()
                                }
                            });
                ...
                w.each(function () {
                    if (!b(this).is(":selected")) {
                        if (b(this).text().toLowerCase().match(v) != null) {
                            ddOptionLI = b("<li>", {
                                "class": u, rel: escape(b(this).val()), click: function (y) {
                                    y.stopPropagation();
                                    c(b(this))
            ...
            function q(t) {
                ddSelectedOptSpan = b("<span>", {
                    "class": "ddSelectedOptSpan", rel: t.val(), click: function (u) {
                        u.stopPropagation();
                        g(b(this))
                    }
                });
